 ...
 */
public class StockServletTwitter extends HttpServlet {
...
out.print("<form action=\"YahooQuoteWithTwitter.jsp\">");
...
out.print("Twitter Social activity Count   ==>  ");
out.print(" <input type=\"radio\" name=\"enabled\" value=\"true\" checked> Enable     ");
out.print("    <input type=\"radio\" name=\"enabled\" value=\"false\" > Disable <br>");
                                

out.print("<input type=\"submit\" value=\"Submit\">");
out.print("</form>");
out.println("<P>");
out.print("<img src=\"stock.gif\" alt=\"stock market View\" >");
out.println("<img src=\"twitter-logo.gif\" alt=\"twitter\" >");
